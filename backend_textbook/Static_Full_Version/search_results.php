                        ...
                        <div class="navbar-collapse collapse" id="navbar">
                            <ul class="navbar-nav navbar-right nav">
                                <li>
                                    ...
                                    <a class="underline" ; href="home.php">Home
                        </a>
                        ...
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="m-t text-right">
                                    <a href="#" data-id ='; echo "\"{$result[$i]['id']}\""; echo 'class="btn btn-xs btn-outline btn-primary bought" data-toggle="modal" data-target="#buyModal">Buy <i class="fa fa-long-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
